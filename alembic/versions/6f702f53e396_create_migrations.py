...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('email', sa.VARCHAR(length=225),
                  autoincrement=False, nullable=False),
        sa.Column('first_name', sa.VARCHAR(length=225),
                  autoincrement=False, nullable=True),
        sa.Column('middle_name', sa.VARCHAR(length=225),
                  autoincrement=False, nullable=True),
        sa.Column('last_name', sa.VARCHAR(length=225),
                  autoincrement=False, nullable=True),
        sa.Column('hashed_password', postgresql.BYTEA(),
                  autoincrement=False, nullable=False),
        sa.Column('refresh_token', sa.VARCHAR(length=225),
                  autoincrement=False, nullable=True),
        sa.Column('access_token', sa.VARCHAR(length=225),
                  autoincrement=False, nullable=True),
    ...
    op.create_table(
        'waitlist',
        sa.Column('email', sa.String(225), nullable=False),
        sa.Column('date_waitlist', sa.TIMESTAMP(
